Public Class clsMaintenanceMaterialRequirementProcessor : Inherits clsMaintenanceMaterialRequirementInfo
...
Public Class colMaintenanceMaterialRequirementProcessors : Inherits List(Of clsMaintenanceMaterialRequirementProcessor)
