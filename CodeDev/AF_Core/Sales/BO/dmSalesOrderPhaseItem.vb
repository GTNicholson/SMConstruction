...
Public Class dmSalesOrderPhaseItem : Inherits dmBase
  ...
  Protected Overrides Sub NewSetup()
    ...
    WorkOrderAllocation = New dmWorkOrderAllocation
  End Sub
  ...
  Public Overrides ReadOnly Property IsAnyDirty() As Boolean
    Get
      ...
      If mAnyDirty = False Then mAnyDirty = WorkOrderAllocation.IsDirty
  ...
  Public Overrides Sub CloneTo(ByRef rNewItem As dmBase)
    With CType(rNewItem, dmSalesOrderPhaseItem)
      ...
      .WorkOrderAllocation = WorkOrderAllocation.Clone
...
Public Class colSalesOrderPhaseItems : Inherits colBase(Of dmSalesOrderPhaseItem)
  ...
  Public Function ItemFromSalesItemKey(ByVal vSalesOrderItemID As Integer) As dmSalesOrderPhaseItem
    Dim mItem As dmSalesOrderPhaseItem
    ...
    For Each mItem In Me
      ...
      If mItem.SalesItemID = vSalesOrderItemID Then
        mRetVal = mItem
        Exit For
      End If
    Next
