...
Public Class dsoAppRefLists
   ...
   Public Function LoadAList(ByRef rRefLists As appRefLists, ByVal vRefListType As Integer) As Boolean
      ...
      If Not mItem Is Nothing Then
         Select Case vRefListType
            ...
            Case appRefLists.Machinery
               mItem.IList = LoadMachinery()
               mOK = True
   ...
   Private Function LoadMachinery() As IList
      Dim mdto As New dtoMachinery(pDBConn)
      Dim mRetVal As New colMachinerys

      mdto.LoadMachineryCollection(mRetVal)
