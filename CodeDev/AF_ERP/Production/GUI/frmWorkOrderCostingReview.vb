...
Public Class frmWorkOrderCostingReview
  ...
  Public Shared Sub OpenModal(ByRef rDBConn As clsDBConnBase)
    Dim mfrm As frmWorkOrderCostingReview
    mfrm = New frmWorkOrderCostingReview
    mfrm.pFormController = New fccProjectReviewAll(rDBConn)
    mfrm.ShowDialog()
  End Sub

  Private Sub frmWorkOrderCostingReview_Load(sender As Object, e As EventArgs) Handles Me.Load
  ...
  Public Shared Sub OpenForm(ByVal vRTISGlobal As AppRTISGlobal, ByVal vDBConn As RTIS.DataLayer.clsDBConnBase, ByVal vMDIForm As Form)
    Dim mfrm As frmWorkOrderCostingReview = Nothing
  ...
  Private Shared Function GetFormIfLoaded() As frmWorkOrderCostingReview
    Dim mfrmWanted As frmWorkOrderCostingReview = Nothing
    Dim mFound As Boolean = False
    Dim mfrm As frmWorkOrderCostingReview
    'Check if exisits already
    If sActiveForms Is Nothing Then sActiveForms = New Collection
    For Each mfrm In sActiveForms
      If TypeOf mfrm Is frmWorkOrderCostingReview Then
        mfrmWanted = mfrm
        mFound = True
        Exit For
      End If
