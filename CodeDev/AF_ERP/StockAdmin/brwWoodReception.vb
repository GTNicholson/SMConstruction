...
Public Class brwWoodReception : Inherits brwBrowserListBase
  ...
  Public Overrides Function AddButtonClicked(ByVal sender As Object, ByVal e As System.EventArgs, ByRef rForm As Windows.Forms.Form) As Boolean ''Implements intBrowseList.AddButtonClicked
    ...
    frmWoodReception.OpenForm(rForm.ParentForm, Me.DBConn, Me.RTISGlobal, 0)
  ...
  Public Overrides Function EditButtonClicked(ByVal sender As Object, ByVal e As System.EventArgs, ByRef rForm As Windows.Forms.Form) As Boolean ''Implements intBrowseList.EditButtonClicked
    ...
    Else
      frmWoodReception.OpenForm(rForm.ParentForm, pDBConn, pRTISGlobal, mGridView.GetFocusedRowCellValue(mGridView.Columns("ReceptionID")))
  ...
  Public Overrides Function LoadData() As Boolean 'Implements intBrowseList.LoadData
    ...
    Dim mdso As dsoReception
    Dim mReceptions As New colReceptions
    ...
    Try
      ...
      mdso = New dsoReception(Me.DBConn)

      mdso.LoadReceptionCollections(mReceptions)
      gridBrowseList.DataSource = mReceptions
  ...
  Public Overrides Function PrepareForm() As Boolean 'Implements intBrowseList.PrepareForm
    ...
    Try
      ...
      With CType(Me.BrowseForm, frmBrowseList)
        ...
        .AddListOption("Agregar Recepción", eListOption.DefaultListOption)
  ...
  Public Overrides Function PrepareList() As Boolean
    ...
    Dim mOK As Boolean = True
    Try
      LayoutFile = System.IO.Path.Combine(RTISGlobal.AuxFilePath, "gvlReceptions.xml")
      ListTitle = "Lista de Recepciones"
      GridEditable = False
