...
Public Class BIReportViewLastPurchaseStockItemInfo
  Private Enum eBIStockItemsLayout
    List = 1
    Summary = 2
  End Enum
  ...
  Public Shared Function CreateBIReportViewFactoryStockItem(ByRef rDBConn As clsDBConnBase, ByRef rRTISGlobal As AppRTISGlobal) As clsBIReportView
    ...
    mBIReportView.BIReportSource = StockItemReportSource()
    mBIReportView.DataSourceLoader = New dsoBILastPurchaseStockItemInfo(rDBConn, rRTISGlobal, mBIReportView)
  ...
  Public Shared Function StockItemReportSource() As dmBIReportSource
    ...
    mRepSource.Name = "Última Compra por Artículo"
  ...
  Private Shared Sub AddLayouts(ByVal vReportSource As dmBIReportSource)
    ...
    mRepDDLayout.BIGridLayoutID = eBIStockItemsLayout.List
    mRepDDLayout.InterfaceType = 1
    mRepDDLayout.ParentLayoutID = 0
    mRepDDLayout.LayoutFileName = "BILastPurchaseStockItemList.xml"
    mRepDDLayout.LayoutName = "Última Compra por Artículo"
    vReportSource.BIGridLayouts.Add(mRepDDLayout)


    mRepLayout = New dmBIGridLayout
    mRepLayout.BIGridLayoutID = eBIStockItemsLayout.Summary
    mRepLayout.InterfaceType = 0
    mRepLayout.ParentLayoutID = 0
    mRepLayout.LayoutFileName = "BILastPurchaseStockItemSummary.xml"
    mRepLayout.LayoutName = "Resumen de última compra por artículo"
  ...
  Private Shared Sub AddParams(ByVal vReportSource As dmBIReportSource)
    ...
    'mParam.DefaultValue = eStockDueDateStatus.Received
    'vReportSource.ColManRepParameter.Add(mParam)
  ...
  Private Shared Function CreateRepDefGeneral() As dmBIReportDef
    ...
    mRepDef.Description = "Última Compra por Artículos"
    mRepDef.BIReportDefID = eBIReportDefs.General
    mRepDef.BIGridLayoutID = eBIStockItemsLayout.List
    Return mRepDef
  End Function
