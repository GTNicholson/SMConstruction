...
Public Class BIReportViewTimeSheetEmployee
  ...
  Public Shared Function CreateBIReportViewFactoryTimeSheet(ByRef rDBConn As clsDBConnBase, ByRef rRTISGlobal As AppRTISGlobal) As clsBIReportView
    ...
    mBIReportView.DataSourceLoader = New dsoBITimeSheetEmpleado(rDBConn, rRTISGlobal, mBIReportView, False)
  ...
  Public Shared Function TimeSheetReportSource() As dmBIReportSource
    ...
    mRepSource.Name = "Reporte de Horas de tiempo x Empleado y Tipo Actividad"
  ...
  Private Shared Sub AddLayouts(ByVal vReportSource As dmBIReportSource)
    ...
    mRepLayout.LayoutFileName = "BITimeSheetListEmployee.xml"
    mRepLayout.LayoutName = "Lista de Horas de tiempo x Empleado"
    ...
    mRepLayout.ParentLayoutID = 0
    mRepLayout.LayoutFileName = "BITimeSheetListEmployeeSummary.xml"
    mRepLayout.LayoutName = "Resumen de Horas de tiempo x Empleado"
    vReportSource.BIGridLayouts.Add(mRepLayout)
  ...
  Private Shared Function CreateRepDefGeneral() As dmBIReportDef
    ...
    mRepDef.Description = "Reporte de Horas de tiempo x Empleado"
