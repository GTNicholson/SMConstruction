...
Public Class frmMaintenanceMaterialRequirement
  Private pForceExit As Boolean
  Private pIsActive As Boolean
  Private pFormController As fccMaintenanceMaterialRequirement
  ...
  Public Shared Sub OpenFormAsMDIChild(ByRef rMDI As Windows.Forms.Form, ByRef rRTISGlobal As AppRTISGlobal, ByRef rDBConn As RTIS.DataLayer.clsDBConnBase, ByVal vSalesOrderPhaseID As Integer, ByVal vConsoleOptionView As ePOConsoleOption)
    Dim mfrm As frmMaintenanceMaterialRequirement = Nothing

    mfrm = GetFormIfLoaded(rMDI)
    If mfrm Is Nothing Then
      mfrm = New frmMaintenanceMaterialRequirement
      mfrm.pFormController = New fccMaintenanceMaterialRequirement()
  ...
  Private Shared Function GetFormIfLoaded(ByVal vMdi As Windows.Forms.Form) As frmMaintenanceMaterialRequirement
    Dim mfrmWanted As frmMaintenanceMaterialRequirement = Nothing
    Dim mFound As Boolean = False
    Dim mfrm As frmMaintenanceMaterialRequirement

    'Check if exisits already
    If sActiveForms Is Nothing Then sActiveForms = New Collection
    For Each mfrm In sActiveForms
      If TypeOf mfrm Is frmMaintenanceMaterialRequirement And mfrm.MdiParent Is vMdi Then
        mfrmWanted = mfrm
        mFound = True
        Exit For
      End If
  ...
  Public Property FormController() As fccMaintenanceMaterialRequirement
    Get
      Return pFormController
    End Get
    Set(value As fccMaintenanceMaterialRequirement)
  ...
  Private Sub frmMaintenanceMaterialRequirements_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Try
      ...
      'If pFormController.ViewMode = fccMaintenanceMaterialRequirement.eViewMode.ViewOnly Then
      '  Bar1.Visible = False
      ...
      'End If
      pFormController.OptionView = fccMaintenanceMaterialRequirement.eMatReqOptionView.Hide
  ...
  Private Sub frmMaintenanceMaterialRequirement_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    Try
  ...
  Private Sub frmMaintenanceMaterialRequirement_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
