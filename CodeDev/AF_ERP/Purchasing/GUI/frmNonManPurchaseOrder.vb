...
Public Class frmNonManPurchaseOrder
  ...
  Public Shared Sub OpenFormAsMDIChild(ByRef rParentForm As Windows.Forms.Form, ByRef rDBConn As RTIS.DataLayer.clsDBConnBase, ByRef rUserSession As clsRTISUser, ByRef rRTISGlobal As clsRTISGlobal, ByVal vPrimaryKeyID As Integer, ByVal vFormMode As eFormMode)
    Dim mfrm As frmNonManPurchaseOrder = Nothing
    ...
    If mfrm Is Nothing Then
      mfrm = New frmNonManPurchaseOrder
  ...
  Public Shared Sub OpenFormAsModal(ByRef rParentForm As Windows.Forms.Form, ByRef rDBConn As clsDBConnBase, ByRef rRTISGlobal As clsRTISGlobal, ByRef vPrimaryKeyID As Integer, ByVal vFormMode As eFormMode)
    Dim mfrm As New frmNonManPurchaseOrder
    mfrm.FormController = New fccPurchaseOrder(rDBConn, rRTISGlobal)
  ...
  Private Shared Function GetFormIfLoaded(ByVal vPrimaryKeyID As Integer) As frmNonManPurchaseOrder
    Dim mfrmWanted As frmNonManPurchaseOrder = Nothing
    Dim mFound As Boolean = False
    Dim mfrm As frmNonManPurchaseOrder
  ...
  Private Sub btedSOPhase_Properties_ButtonClick(sender As Object, e As ButtonPressedEventArgs) Handles btedSOPhase.ButtonClick
    Try
      ...
      Dim mSalesOrderPhaseItemInfos As New colSalesOrderPhaseItemInfos
      Dim mSalesOrderPhaseItemInfo As clsSalesOrderPhaseItemInfo
      Dim mSalesOrderPhaseItem As clsSalesOrderPhaseItemInfo
      ...
      If mSalesOrderPhaseItemInfo IsNot Nothing Then
        ...
        pFormController.SalesOrderPhaseItemInfos.Add(mSalesOrderPhaseItemInfo)
        pFormController.SalesOrderPhaseItemInfo = mSalesOrderPhaseItemInfo

        If pFormController.PurchaseOrder.PurchaseOrderAllocations.IndexFromSalesOrderPhaseItemID(mSalesOrderPhaseItemInfo.SalesOrderPhaseItemID) = -1 Then
          mPOAllocation = New dmPurchaseOrderAllocation
          mPOAllocation.SalesorderPhaseItemID = mSalesOrderPhaseItemInfo.SalesOrderPhaseItemID
