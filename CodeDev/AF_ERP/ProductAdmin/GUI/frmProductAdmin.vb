...
Public Class frmProductAdmin
  ...
  Public Shared Sub OpenAsMDI(ByRef rMDIParent As Form, ByRef rDBConn As clsDBConnBase, ByRef rRTISGlobal As AppRTISGlobal, ByRef rRegistry As clsStockItemRegistryBase)
    ...
    If mfrm Is Nothing Then
      ...
      mfrm.pFormController = New fccProductAdmin(rDBConn, rRTISGlobal, rRegistry)
      mfrm.Show()
    Else
      mfrm.Focus()
    End If
  ...
  Public ReadOnly Property FormController As fccProductAdmin
    Get
