...
Public Class frmSalesOrderDetailHousesSmallScreen
  ...
  Public Shared Sub OpenFormMDI(ByVal vPrimaryKeyID As Integer, ByRef rDBConn As RTIS.DataLayer.clsDBConnBase, ByRef rRTISGlobal As AppRTISGlobal, ByRef rParentMDI As frmTabbedMDI)
    Dim mfrm As frmSalesOrderDetailHousesSmallScreen = Nothing

    If vPrimaryKeyID <> 0 Then
      mfrm = GetFormIfLoaded(vPrimaryKeyID)
    End If
    If mfrm Is Nothing Then
      mfrm = New frmSalesOrderDetailHousesSmallScreen
  ...
  Private Shared Function GetFormIfLoaded(ByVal vPrimaryKeyID As Integer) As frmSalesOrderDetailHousesSmallScreen
    Dim mfrmWanted As frmSalesOrderDetailHousesSmallScreen = Nothing
    Dim mFound As Boolean = False
    Dim mfrm As frmSalesOrderDetailHousesSmallScreen
  ...
  Private Sub bbtnViewSummary_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles bbtnViewSummary.ItemClick
    frmSalesOrderReviewSmallScreen.OpenModal(pFormController.SalesOrder, pFormController.DBConn)
