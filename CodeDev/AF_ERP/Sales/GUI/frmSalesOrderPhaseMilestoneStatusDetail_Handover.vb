...
Public Class frmSalesOrderPhaseMilestoneStatusDetail_Handover
  ...
  Public Shared Sub OpenForm(ByRef rParentForm As Windows.Forms.Form, ByRef rDBConn As RTIS.DataLayer.clsDBConnBase, ByRef rSalesOrderPhaseMilestoneStatus As dmSalesOrderPhaseMilestoneStatus, ByVal vSalesOrderPhaseID As Integer, ByVal vCategory As Integer)
    Dim mfrm As frmSalesOrderPhaseMilestoneStatusDetail_Handover

    mfrm = New frmSalesOrderPhaseMilestoneStatusDetail_Handover
  ...
  Private Sub frmSalesOrderPhaseMilestoneStatusDetail_Handover_Load(sender As Object, e As EventArgs) Handles Me.Load
  ...
  Private Sub frmSalesOrderPhaseMilestoneStatusDetail_Handover_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
    UpdateObjects()
    RefreshControls()
  ...
  Private Sub frmSalesOrderPhaseMilestoneStatusDetail_Handover_Closed(sender As Object, e As EventArgs) Handles Me.Closed
