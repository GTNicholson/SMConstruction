...
Public Class repSalesOrder_Spanish
  ...
  Public Shared Function GenerateReport(ByRef rSalesOrder As dmSalesOrder, ByVal vIsVAT As Boolean, ByVal vLanguageOption As Integer) As repSalesOrder_Spanish
