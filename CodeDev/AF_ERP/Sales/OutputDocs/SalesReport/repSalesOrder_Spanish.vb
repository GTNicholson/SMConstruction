...
Public Class repSalesOrder_Spanish
  ...
  Public Shared Function GenerateReport(ByRef rSalesOrder As dmSalesOrder, ByRef rSalesItemEditors As colSalesItemEditors, ByVal vIsVAT As Boolean, ByVal vLanguageOption As Integer, ByVal vSalesHouseID As Integer) As repSalesOrder_Spanish
    Dim mRep As New repSalesOrder_Spanish
  ...
  Private Sub repSalesOrder_BeforePrint(sender As Object, e As Printing.PrintEventArgs) Handles MyBase.BeforePrint
    ...
    xtcNumQuotation.Text = pSalesOrder.SalesOrderHouses.ItemFromKey(pSalesHouseID).Ref
