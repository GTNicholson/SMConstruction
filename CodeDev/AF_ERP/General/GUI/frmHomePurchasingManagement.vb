...
Public Class frmHomePurchasingManagement
  ...
  Private Sub LoadData()
    ...
    pFormController.LoadPurchaseOrderInfosThisYear()
    grdWorkOrderInfo.DataSource = pFormController.PurchaseOrderInfos
  ...
  Private Sub gvWorkOrderInfo_RowCellStyle(sender As Object, e As RowCellStyleEventArgs) Handles gvPurchaseOrderInfo.RowCellStyle
    Try
      'Select Case e.Column.Name
      '  Case gcIngenieria.Name, gcMetal.Name, gcTapizado.Name, gcDespacho.Name
      '    Dim mRow As clsWorkOrderTracking = gvPurchaseOrderInfo.GetRow(e.RowHandle)
  ...
  Private Sub gvWorkOrderInfo_CustomUnboundColumnData(sender As Object, e As CustomColumnDataEventArgs) Handles gvPurchaseOrderInfo.CustomUnboundColumnData
