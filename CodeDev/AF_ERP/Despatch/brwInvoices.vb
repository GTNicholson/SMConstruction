...
Public Class brwInvoices : Inherits brwBrowserListBase
  ...
  Public Overrides Function AddButtonClicked(ByVal sender As Object, ByVal e As System.EventArgs, ByRef rForm As Windows.Forms.Form) As Boolean ''Implements intBrowseList.AddButtonClicked
    ...
    frmInvoice.OpenFormMDI(0, pDBConn, rForm.ParentForm)
  ...
  Public Overrides Function EditButtonClicked(ByVal sender As Object, ByVal e As System.EventArgs, ByRef rForm As Windows.Forms.Form) As Boolean ''Implements intBrowseList.EditButtonClicked
    ...
    Else
      frmInvoice.OpenFormMDI(mGridView.GetFocusedRowCellValue(mGridView.Columns("InvoiceID")), pDBConn, rForm.ParentForm)
  ...
  Public Overrides Function PrepareForm() As Boolean 'Implements intBrowseList.PrepareForm
    ...
    Try
      ...
      With CType(Me.BrowseForm, frmBrowseList)
        ...
        .AddListOption("Activar Factura", eListOption.DefaultListOption)
        .AddListOption("Nueva Factura", eListOption.DefaultListOption)
        .AddListOption("Factura vencida", eListOption.DefaultListOption)
        ...
        .AddViewOption("Ver Consultas de Facturas", eAddEditDeleteView.AlternateForm)

        .AddProcessOption("Mail-shot active Factura", AddressOf BatchProcessExecute)
  ...
  Public Overrides Function PrepareList() As Boolean
    ...
    Dim mOK As Boolean = True
    Try
      LayoutFile = System.IO.Path.Combine(RTISGlobal.AuxFilePath, "gvlInvoice.xml")
