...
Public Class frmWoodProcessRollo
  ...
  Public Shared Sub OpenForm(ByRef rMDIForm As frmTabbedMDI, ByRef rDBConn As RTIS.DataLayer.clsDBConnBase, ByRef rRTISGlobal As AppRTISGlobal, ByVal vWorkOrderID As Integer, ByVal vSourceItemType As Integer, ByVal vTargetItemType As Integer, ByVal vAddingOption As eWorkOrderWoodProcess)
    Dim mfrm As frmWoodProcessRollo = Nothing
  ...
  Private Shared Function GetFormIfLoaded(ByVal vPrimaryKeyID As Integer) As frmWoodProcessRollo
    Dim mfrmWanted As frmWoodProcessRollo = Nothing
    Dim mFound As Boolean = False
    Dim mfrm As frmWoodProcessRollo
  ...
  Private Sub frmWoodProcessRollo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
  ...
  Private Sub SetupTabOptionControls()
    ...
    Select Case pFormController.CurrentWoodWorkOrder.WorkOrderProcessOption
      ...
      Case eWorkOrderWoodProcess.Aserrio
        white.Text = "Detalles de Registro para el Aserrío"
  ...
  Private Sub frmWoodProcessRollo_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
  ...
  Private Sub frmWoodProcessRollo_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
  ...
  Private Sub UpdateSourcetWoodPalletItems()

    Dim mWPI As dmWoodPalletItem
    Dim mToUpdateListWPI As New colWoodPalletItems
    If grdSourceWoodPalletItem.DataSource IsNot Nothing Then
      For Each mItem In grdSourceWoodPalletItem.DataSource
      ...
      If mToUpdateListWPI.Count > 0 Then
        ...
        For Each mOutputWPI In pFormController.CurrentSourceWoodPallet.WoodPalletItems
  ...
  Private Sub grpConsumedWoodPalletItemInfo_CustomButtonClick(sender As Object, e As BaseButtonEventArgs) Handles grpConsumedWoodPalletItemInfo.CustomButtonClick
    ...
    Select Case e.Button.Properties.Tag
      ...
      Case ePalletOptions.AddWoodItem
        ...
        Dim mSelectedStockItems As New colStockItems

        mListFilteredSpecieID = pFormController.CurrentSourceWoodPallet.GetAllSpeciesInWoodPalletGuideItems
        ...
        For Each mItem As KeyValuePair(Of Integer, RTIS.ERPStock.intStockItemDef) In AppRTISGlobal.GetInstance.StockItemRegistry.StockItemsDict
          ...
          If mSI IsNot Nothing Then
            ...
            If mSI.Category = eStockItemCategory.Timber And mSI.ItemType = CInt(eStockItemTypeTimberWood.Rollo) And mListFilteredSpecieID.Contains(mSI.Species) Then
        ...
        End If
        mPickerStockItem = New clsPickerStockItem(mStockItems, pFormController.DBConn, AppRTISGlobal.GetInstance)
        ...
        For Each mWoodPalletItem As dmWoodPalletItem In pFormController.CurrentSourceWoodPallet.WoodPalletItems
          If mWoodPalletItem.StockItemID > 0 Then
            ...
            If Not mPickerStockItem.SelectedObjects.Contains(mStockItem) Then
              mPickerStockItem.SelectedObjects.Add(mStockItem)
            End If
          End If
        Next

        frmPickerStockItem.OpenPickerMulti(mPickerStockItem, True, pFormController.DBConn, AppRTISGlobal.GetInstance, True, pFormController.CurrentSourceWoodPallet.PalletType)

        For Each mSelectedItem In mPickerStockItem.SelectedObjects
          ...
          If mSelectedItem IsNot Nothing Then
            ...
            If mNewWoodPalletItem Is Nothing Then
              ...
              mNewWoodPalletItem.WoodPalletID = pFormController.CurrentSourceWoodPallet.WoodPalletID
              ...
              mNewWoodPalletItem.Quantity = 1
              mWoodPalletItemEditor.StockItem = mSelectedItem
              mWoodPalletItemEditor.WoodPalletItem = mNewWoodPalletItem

              pFormController.CurrentSourceWoodPallet.WoodPalletItems.Add(mNewWoodPalletItem)
              pFormController.SaveWoodPalletDown(pFormController.CurrentSourceWoodPallet)

              pFormController.SourceWoodPalletItemEditors.Add(mWoodPalletItemEditor)
            End If
          End If
        Next

        mSelectedStockItems = New colStockItems(mPickerStockItem.SelectedObjects)
  ...
  Private Sub btnStartKiln_Click(sender As Object, e As EventArgs)
    UpdateWoodPalletRef()
    CheckSave(False)
    RefreshControls()
  End Sub

  Private Sub btnEndKiln_Click(sender As Object, e As EventArgs)
      ...
      Select Case e.Column.Name
        ...
        Case gcVolume.Name
          If e.IsGetData Then
            ...
            mVolume = Math.Pow(mWPIE.WoodPalletItem.Thickness, 2) * mWPIE.WoodPalletItem.Length * clsConstants.cConstantVolumeHubert

            mWPIE.WoodPalletItem.VolumeM3 = mVolume
            e.Value = mVolume
          End If
      End Select
